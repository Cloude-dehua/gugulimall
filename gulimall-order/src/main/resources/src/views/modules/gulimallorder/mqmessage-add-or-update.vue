    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.messageId) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallorder/mqmessage/info/${this.dataForm.messageId}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/gulimallorder/mqmessage/${!this.dataForm.messageId ? 'save' : 'update'}`),
              method: 'post',
